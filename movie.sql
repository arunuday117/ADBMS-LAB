...
SELECT DISTINCT actor,director FROM  DIRECTORS NATURAL JOIN MOVIES NATURAL JOIN ACTS NATURAL JOIN ACTORS WHERE DIRECTORS.director=MOVIES.director AND MOVIES.title=ACTS.title AND ACTS.actor=ACTORS.actor;
